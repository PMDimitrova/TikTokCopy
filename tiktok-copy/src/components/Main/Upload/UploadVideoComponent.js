...
export default function UploadVideoComponent() {
    ...
    const postVideo = () => {
        ...
        setShowAlert(true);
        //todo -> setTimeout and redirect to home
    }
                    ...
                    <div className={styles.uploadBody}>
                        <div className={styles.uploadSideContainer}>
                            {urlOfNewUpload==='' ? (
                                ...
                                <div className={styles.uploadSideTopics}>
                                    <img src={uploadLogo} alt={'upload'} style={{marginBottom: 18}}/>
                                    <div className={styles.uploadSelectedVidText} style={{fontWeight:600}}>Selected video:</div>
                        ...
                        <div className={styles.uploadMainContainer}>
                            ...
                            {showSuccessAlert ?
                                (<Alert className={styles.uploadSuccessAlert} variant="outlined">Video uploaded successfully!</Alert>)
                                : (<></>)
                            }
